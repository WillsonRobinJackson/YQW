...
class ResumeModel extends RelationModel{
	...
	protected $_auto = array (
		...
		array('CurrIncome',10000), // 目前年收入
		array('isOpenNumber',1), // 是否公开手机号
		array('OpenLevel',1),//公开程度
		array('isOverseasStudy',0), // 是否有海外学习工作经历(1->是)
	...
	*/
	public function add_resume($data,$user){
		...
		if(false === $d = $this->create($data)){
			...
			$this->CurrIncome  = '100.00';
			$this->isOpenNumber  = 1;
			$this->OpenLevel  = 1;
			$this->isOverseasStudy  = 0;
